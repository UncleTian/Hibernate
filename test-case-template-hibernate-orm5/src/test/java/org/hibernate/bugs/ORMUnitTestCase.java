...
import org.hibernate.domain.config.Student;
...
//	}
	...
	// If those mappings reside somewhere other than
	// resources/org/hibernate/test, change this.
	@Override
	...
	protected void configure(Configuration configuration) {
		...
		configuration.setProperty(AvailableSettings.FORMAT_SQL,
				Boolean.TRUE.toString());
		configuration.setProperty(AvailableSettings.HBM2DDL_AUTO,
				"none");
	}
	...
	public void hhh123Test() throws Exception {
		// BaseCoreFunctionalTestCase automatically creates the SessionFactory
		// and provides the Session.
		Session s = openSession();
		Transaction tx = s.beginTransaction();

		Student student = s.get(Student.class, 1L);
